    ...
    for show_time in show_times:
        ...
        for room in xrange(1,6):
            for program in programs:
                ...
                write_raw('\n')
                write_line('    <table id="t%s" class="program-post">' % id)
                write_line('        <tr>')
                write_line('            <th class="favourite" id="f%s">' % id)
                write_line('                <span>Sal&nbsp;%s</span>' % room)
                write_line('                </br>')
                write_line('                <img alt="favourite" class="fav-icon" src="http://raiom.no/tdconf-test-program/ico/star_unsel.png">')
                write_line('            </th>')
                ...
                write_line('                </div>')
                write_line('            </td>')
                write_line('            <td class="kebab-icon">')
                write_line('                <img alt="favourite" src="http://raiom.no/tdconf-test-program/ico/arrow-down.png">')
